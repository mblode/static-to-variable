...
Head to [blode.co/variable](https://blode.co/variable): drop your fonts in and build right in the browser, or explore demos built from Google Fonts that never had a variable version.
