...
[blode.co/variable](https://blode.co/variable) has variable fonts built from Google Fonts families that never shipped one, so you can slide through the weights before installing anything.
